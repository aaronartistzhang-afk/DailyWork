...
test("reviewer prompt is generic and does not expose personal profile labels", () => {
  ...
  assert.doesNotMatch(prompt, /Wang|Yanran|wangyanran|王|嫣然|04-09|05-07|LEON|Review Ranger|Campaign Platform/);
});
...
test("reviewer prompt includes latest group calibration without personal labels", () => {
  ...
  assert.doesNotMatch(prompt, /Wang|Yanran|wangyanran|王|嫣然|05-14/);
});
